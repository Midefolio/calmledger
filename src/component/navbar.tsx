...
const NavBar = () => {
    ...
    return (
        <>
            <nav className="flex flex-col shadow-sm absolute z-5090 w-full backdrop-blur-2xl">
                        ...
                        {navLinks.map((link) => {
                            ...
                            return (
                                <a
                                    key={link.name}
                                    href={link.path}
                                    className={`uppercase pb-3 relative group font-bold transition-all duration-300 hover:text-[#fff] hover:scale-105 ${isActive ? 'text-[#fff] font-semibold' : ''
                                        }`}
                                >
                                    {link.label}
                                    <span
                                        className={`absolute left-0 bottom-0 h-0.5 bg-[#03706d] transition-all duration-300 group-hover:w-full ${isActive ? 'w-full' : 'w-0'
                                            }`}
                                    ></span>
                                </a>
                            );
                                            ...
                                            return (
                                                <motion.a
                                                    ...
                                                    className={`px-6 py-4 text-lg font-semibold transition-all duration-300 border-l-4 ${isActive 
                                                        ...
                                                        : 'text-gray-700 border-transparent hover:text-[#408a87] hover:border-blue-300 hover:bg-gray-50'
                                                    }`}
                                                >
                                                    {link.label}
                                                </motion.a>
